" Name:         meow
" Description:  Theme, based on the standard 'evening' theme.
" Author:       Original author eltonzip <https://github.com/eltonzip>
" Maintainer:   Original maintainer eltonzip
...
hi Normal guifg=#ffffff guibg=#353535 gui=NONE cterm=NONE
...
hi EndOfBuffer guifg=#add8e6 guibg=#2c2c2c gui=NONE cterm=NONE
hi StatusLine guifg=white guibg=#5a5a5a gui=bold cterm=bold
hi StatusLineNC guifg=lightgrey guibg=black gui=NONE cterm=NONE
...
hi Cursor guifg=#00f7ff guibg=#00ff00 gui=NONE cterm=NONE
...
hi Comment guifg=#c2fac2 guibg=NONE gui=NONE cterm=NONE
hi Constant guifg=#ff8686 guibg=NONE gui=NONE cterm=NONE
hi Identifier guifg=white guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=#333333 guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#ff80ff guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#c4ff64 guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#5f97ff guibg=NONE gui=bold cterm=bold
